    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                Log.e("Google Auth", "firebaseAuthWithGoogle:" + account.getEmail());
                Log.e("Google Aut", "firebaseAuthWithGoogle:" + account.getDisplayName());
                Log.e("Google Auth", "firebaseAuthWithGoogle:" + account.getPhotoUrl());
                ...
                Log.e("Google Auth", "Google sign in failed", e);
            }
        }
    }
