            ...
            apiCall.Insert(mp, "getPet_List.php", new VolleyCallback() {
                ...
                public void onSuccess(String result) {
                    try {
                                    ...
                                    apiCall.Insert(ms, "delete_Your_Pets.php", new VolleyCallback() {
                                        ...
                                        public void onSuccess(String result) {
                                           if (result.trim().equals("1")){
                                               ...
                                               Toast.makeText(Your_Pets_List.this, "Can`t delete it try again!", Toast.LENGTH_SHORT).show();
                                           }
                                        }
                                    });
                                }
                        ...
                        Toast.makeText(Your_Pets_List.this, "Error occurred try again", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
