    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        apiCall.get("getContact.php", new VolleyCallback() {
            ...
            try {
                ...
                name.setText("E-Woof Trials");
                address.setText("City University of Science & Information Technology");
                mobile.setText("0315-9011036");
                email.setText("ewooftrial@gmail.com");
