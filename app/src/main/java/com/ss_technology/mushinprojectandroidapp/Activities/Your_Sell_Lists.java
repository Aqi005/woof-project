...
public class Your_Sell_Lists extends AppCompatActivity {
            ...
            apiCall.Insert(mp, "getUserPost.php", new VolleyCallback() {
                ...
                public void onSuccess(String result) {
                    try{
                        ...
                        if (!list.isEmpty()){
                            adapter=new Your_Sell_Pets_Post_Adapter(Your_Sell_Lists.this,true, list, new Your_Sell_Pets_Post_Adapter.Delete_Click() {
                                @Override
                                    ...
                                    apiCall.Insert(ms, "delete_sell_pets_post.php", new VolleyCallback() {
                                        ...
                                        public void onSuccess(String result) {
                                            if(result.trim().equals("1")){
                                                Toast.makeText(Your_Sell_Lists.this, "Successfully deleted!", Toast.LENGTH_SHORT).show();
                                                list.remove(position);
                                                adapter.notifyDataSetChanged();
                                            }
                                            else{
                                                Toast.makeText(Your_Sell_Lists.this, "Error occured try again!", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
                                }
                            ...
                            rec.setLayoutManager(new LinearLayoutManager(Your_Sell_Lists.this));
                            rec.setAdapter(adapter);
                        }
                        else {
                            Toast.makeText(Your_Sell_Lists.this, "Nothing to show!", Toast.LENGTH_SHORT).show();
                        }
                    }
                    catch (Exception e){
                        Toast.makeText(Your_Sell_Lists.this, "Error occured in Json Parsing", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    private void init(){
        ...
        Bitmap bitmap= BitmapFactory.decodeResource(Your_Sell_Lists.this.getResources(),R.drawable.back_image);
